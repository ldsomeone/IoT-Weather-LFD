...
void setup(void) {
  ...
  rest.variable("humidity", &percentageOfMaxCapacity);
  ...
  IPAddress ip(192, 168, 1, 102);     //set static ip
...
void loop() {
  ...
  percentageOfMaxCapacity = (currentWaterTankCapacity / (PI * radius * radius * maxDepth)) * 100;
